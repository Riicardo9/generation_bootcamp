...
const inputs = document.querySelectorAll('input') //Selecciona todos los inputs, si se coloca sin all trae solo el primer input que encuentre
//console.log(inputs)

const nombreError = document.querySelector("#errorNombre") //# para indicar que es mediante id (si se usa getelementbyid no es necesario)
...
inputs.forEach((inp)=>{ //recorre todos los slementos de input, tambien se puede hacer por separado pero es mas rapido con un foreach
	//console.log(inp)
...
formulario.addEventListener('submit', (e)=>{
	e.preventDefault();
	/* console.log(Object.values(statusInf)) //imprime el valor de cada elemento del objeto statusInf
